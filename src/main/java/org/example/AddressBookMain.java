...
public class AddressBookMain {
    ...
    //Provided person details
    {
        ...
        addressBook.add(new personDetails("Jagan", "Saran", "Chennai", "Chennai", "TamilNadu", 600012, 9940698983L));
        addressBook.add(new personDetails("Dhanush", "Pandi", "Delhi", "Delhi", "Delhi", 789456, 9632145696L));
        addressBook.add(new personDetails("Abirami", "Suresh", "Bangalore", "Bangalore", "Karnataka", 987654, 8978978979L));
        addressBook1.add(new personDetails("Pavithra", "Balaji", "Pune", "pune", "Maharashtra", 456456, 9156874527L));
        addressBook1.add(new personDetails("Kamal", "Murugesan", "Hyderabad", "Hyderabad", "Andhra", 369258, 9321356488L));
        addressBook1.add(new personDetails("Swetha", "Swe", "Kalamboli", "Kalamboli", "Maharashtra", 123456, 7741258926L));
